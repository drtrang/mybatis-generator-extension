...
public class CustomJavaTypeResolver implements JavaTypeResolver {
    ...
    public void addConfigurationProperties(Properties properties) {
        ...
        forceLongs = StringUtility.isTrue(properties.getProperty("forceLongs"));
    }
...
//		System.out.println(introspectedColumn.getDefaultValue());
//		System.out.println(introspectedColumn.getJavaProperty());
//		System.out.println(introspectedColumn.getJdbcType());
//		System.out.println(introspectedColumn.getJdbcTypeName());
//		System.out.println(introspectedColumn.getLength());
//		System.out.println(introspectedColumn.getRemarks());
//		System.out.println(introspectedColumn.getScale());
        ...
        if (jdbcTypeInformation == null) {
            switch (introspectedColumn.getJdbcType()) {
                ...
                case Types.NUMERIC:
                    ...
                    } else if (introspectedColumn.getScale() > 0 || introspectedColumn.getLength() > 18) {
                        answer = new FullyQualifiedJavaType(BigDecimal.class.getName());
